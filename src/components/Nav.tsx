...
const Container = ({ children }: { children: React.ReactNode }) => (
    <nav className="flex w-full z-[100] justify-between items-center h-[96px] px-[24px]
...
const Links = ({ setOpen }: { setOpen: Function }) => {
...
const MobileMenu = ({ setOpen }: { setOpen: Function }) => (
